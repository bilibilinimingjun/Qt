...
public:
    ...
    QPushButton *pushButton_dataSendEnable;
    QPushButton *pushButton_dataVariety;
    QSpacerItem *verticalSpacer_6;
    QHBoxLayout *horizontalLayout_5;
    QLabel *label_7;
    QComboBox *comboBox_mode;
    QGridLayout *gridLayout_3;
    QPushButton *pushButton_ending;
    QPushButton *pushButton_readSetting;
    QPushButton *pushButton_writeSetting;
    QPushButton *pushButton_start;
    QSpacerItem *verticalSpacer_5;
    QTableWidget *tableWidget_baseStation;
    QTableWidget *tableWidget_tagId;
    QWidget *tab_3;
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        layoutWidget->setGeometry(QRect(0, 0, 1031, 601));
...
"}"));
        ...
        layoutWidget1->setGeometry(QRect(10, 10, 801, 571));
...
"}"));
        ...
        layoutWidget2->setGeometry(QRect(5, 3, 811, 591));
        ...
        pushButton_dataSendEnable = new QPushButton(layoutWidget2);
        pushButton_dataSendEnable->setObjectName(QString::fromUtf8("pushButton_dataSendEnable"));

        verticalLayout_2->addWidget(pushButton_dataSendEnable);

        pushButton_dataVariety = new QPushButton(layoutWidget2);
        pushButton_dataVariety->setObjectName(QString::fromUtf8("pushButton_dataVariety"));

        verticalLayout_2->addWidget(pushButton_dataVariety);
        ...
        comboBox_mode = new QComboBox(layoutWidget2);
        ...
        pushButton_ending = new QPushButton(layoutWidget2);
        pushButton_ending->setObjectName(QString::fromUtf8("pushButton_ending"));

        gridLayout_3->addWidget(pushButton_ending, 1, 1, 1, 1);

        pushButton_readSetting = new QPushButton(layoutWidget2);
        pushButton_readSetting->setObjectName(QString::fromUtf8("pushButton_readSetting"));

        gridLayout_3->addWidget(pushButton_readSetting, 0, 0, 1, 1);

        pushButton_writeSetting = new QPushButton(layoutWidget2);
        pushButton_writeSetting->setObjectName(QString::fromUtf8("pushButton_writeSetting"));

        gridLayout_3->addWidget(pushButton_writeSetting, 0, 1, 1, 1);

        pushButton_start = new QPushButton(layoutWidget2);
        pushButton_start->setObjectName(QString::fromUtf8("pushButton_start"));

        gridLayout_3->addWidget(pushButton_start, 1, 0, 1, 1);
        ...
        tableWidget_baseStation = new QTableWidget(layoutWidget2);
        if (tableWidget_baseStation->columnCount() < 4)
            tableWidget_baseStation->setColumnCount(4);
        QTableWidgetItem *__qtablewidgetitem = new QTableWidgetItem();
        tableWidget_baseStation->setHorizontalHeaderItem(0, __qtablewidgetitem);
        QTableWidgetItem *__qtablewidgetitem1 = new QTableWidgetItem();
        tableWidget_baseStation->setHorizontalHeaderItem(1, __qtablewidgetitem1);
        QTableWidgetItem *__qtablewidgetitem2 = new QTableWidgetItem();
        tableWidget_baseStation->setHorizontalHeaderItem(2, __qtablewidgetitem2);
        QTableWidgetItem *__qtablewidgetitem3 = new QTableWidgetItem();
        tableWidget_baseStation->setHorizontalHeaderItem(3, __qtablewidgetitem3);
        tableWidget_baseStation->setObjectName(QString::fromUtf8("tableWidget_baseStation"));

        horizontalLayout_7->addWidget(tableWidget_baseStation);


        verticalLayout_3->addLayout(horizontalLayout_7);

        tableWidget_tagId = new QTableWidget(layoutWidget2);
        if (tableWidget_tagId->columnCount() < 8)
            tableWidget_tagId->setColumnCount(8);
        QTableWidgetItem *__qtablewidgetitem4 = new QTableWidgetItem();
        tableWidget_tagId->setHorizontalHeaderItem(0, __qtablewidgetitem4);
        QTableWidgetItem *__qtablewidgetitem5 = new QTableWidgetItem();
        tableWidget_tagId->setHorizontalHeaderItem(1, __qtablewidgetitem5);
        QTableWidgetItem *__qtablewidgetitem6 = new QTableWidgetItem();
        tableWidget_tagId->setHorizontalHeaderItem(2, __qtablewidgetitem6);
        QTableWidgetItem *__qtablewidgetitem7 = new QTableWidgetItem();
        tableWidget_tagId->setHorizontalHeaderItem(3, __qtablewidgetitem7);
        QTableWidgetItem *__qtablewidgetitem8 = new QTableWidgetItem();
        tableWidget_tagId->setHorizontalHeaderItem(4, __qtablewidgetitem8);
        QTableWidgetItem *__qtablewidgetitem9 = new QTableWidgetItem();
        tableWidget_tagId->setHorizontalHeaderItem(5, __qtablewidgetitem9);
        QTableWidgetItem *__qtablewidgetitem10 = new QTableWidgetItem();
        tableWidget_tagId->setHorizontalHeaderItem(6, __qtablewidgetitem10);
        QTableWidgetItem *__qtablewidgetitem11 = new QTableWidgetItem();
        tableWidget_tagId->setHorizontalHeaderItem(7, __qtablewidgetitem11);
        tableWidget_tagId->setObjectName(QString::fromUtf8("tableWidget_tagId"));

        verticalLayout_3->addWidget(tableWidget_tagId);
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        pushButton_dataSendEnable->setText(QApplication::translate("Widget", "\346\265\213\350\267\235\345\256\232\344\275\215\344\275\277\350\203\275", nullptr));
        pushButton_dataVariety->setText(QApplication::translate("Widget", "\344\270\273\346\234\272\347\253\231\350\276\223\345\207\272\345\215\217\350\256\256", nullptr));
        label_7->setText(QApplication::translate("Widget", "\345\256\232\344\275\215\346\250\241\345\274\217\357\274\232", nullptr));
        comboBox_mode->setItemText(0, QApplication::translate("Widget", "\344\272\214\347\273\264\345\256\232\344\275\215\346\250\241\345\274\217", nullptr));
        comboBox_mode->setItemText(1, QApplication::translate("Widget", "\344\270\200\345\257\271\344\270\200\346\265\213\350\267\235\346\250\241\345\274\217", nullptr));

        pushButton_ending->setText(QApplication::translate("Widget", "\345\217\226\346\266\210\345\256\232\344\275\215", nullptr));
        pushButton_readSetting->setText(QApplication::translate("Widget", "\350\257\273\345\217\226\351\205\215\347\275\256", nullptr));
        pushButton_writeSetting->setText(QApplication::translate("Widget", "\350\275\275\345\205\245\351\205\215\347\275\256", nullptr));
        pushButton_start->setText(QApplication::translate("Widget", "\345\274\200\345\247\213\345\256\232\344\275\215", nullptr));
        QTableWidgetItem *___qtablewidgetitem = tableWidget_baseStation->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("Widget", "\345\237\272\347\253\231ID", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget_baseStation->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("Widget", "X", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget_baseStation->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("Widget", "Y", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget_baseStation->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("Widget", "Z", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = tableWidget_tagId->horizontalHeaderItem(0);
        ___qtablewidgetitem4->setText(QApplication::translate("Widget", "TAG_ID", nullptr));
        QTableWidgetItem *___qtablewidgetitem5 = tableWidget_tagId->horizontalHeaderItem(1);
        ___qtablewidgetitem5->setText(QApplication::translate("Widget", "X", nullptr));
        QTableWidgetItem *___qtablewidgetitem6 = tableWidget_tagId->horizontalHeaderItem(2);
        ___qtablewidgetitem6->setText(QApplication::translate("Widget", "Y", nullptr));
        QTableWidgetItem *___qtablewidgetitem7 = tableWidget_tagId->horizontalHeaderItem(3);
        ___qtablewidgetitem7->setText(QApplication::translate("Widget", "Z", nullptr));
        QTableWidgetItem *___qtablewidgetitem8 = tableWidget_tagId->horizontalHeaderItem(4);
        ___qtablewidgetitem8->setText(QApplication::translate("Widget", "A\345\237\272\347\253\231", nullptr));
        QTableWidgetItem *___qtablewidgetitem9 = tableWidget_tagId->horizontalHeaderItem(5);
        ___qtablewidgetitem9->setText(QApplication::translate("Widget", "B\345\237\272\347\253\231", nullptr));
        QTableWidgetItem *___qtablewidgetitem10 = tableWidget_tagId->horizontalHeaderItem(6);
        ___qtablewidgetitem10->setText(QApplication::translate("Widget", "C\345\237\272\347\253\231", nullptr));
        QTableWidgetItem *___qtablewidgetitem11 = tableWidget_tagId->horizontalHeaderItem(7);
        ___qtablewidgetitem11->setText(QApplication::translate("Widget", "D\345\237\272\347\253\231", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("Widget", "\351\241\265", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("Widget", "Tab 2", nullptr));
    } // retranslateUi
